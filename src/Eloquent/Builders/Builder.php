...
class Builder extends EloquentBuilder
{
     ...
     * @return mixed
     */
    protected function  getModelTableColumn($column)
    {

        if (is_string($column) && strstr($column, '.') === false && method_exists($this->model, 'getTableColumn')) {
            return $this->model->getTableColumn($column);
        }
